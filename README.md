...
AI instruction files in `.cursor/rules/*.mdc` format, packaged as Cursor Team Marketplace plugins. Each is graded against the public Tome Standard and kept current as the models change by [TomeVault](https://tomevault.io).
